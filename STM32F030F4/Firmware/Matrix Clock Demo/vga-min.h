...
extern uint16_t VGA_Line;					// current VGA line
extern volatile uint16_t MicroTimer0;

void   VGA_Init(void);
void   Delay(uint16_t Ticks);
extern void (* VerticalBlank)(void);
...
// Display_Flags
#define VGA_BUFFER0				0x00


#define VGA_BUFFER1				0x01
#define VGA_BUFFER				VGA_BUFFER1
#define VGA_RENDER				0x40
#define VGA_DISPLAY				0x80

// PB1 to show active video
//#define DMA_SPI_TIMING_TWEAK
...
// Check with a logic analyzer if IRQ code is altered or use different compiler.
#define VGA_IRQ_Latency 	80

//define DMA_SPI_TIMING_TWEAK

#define VGA_TEXT_X				(VGA_RES_X/FONT_COL)
#define VGA_TEXT_Y				(VGA_RES_Y/FONT_ROW)
